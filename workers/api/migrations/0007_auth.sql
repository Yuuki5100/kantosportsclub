...
(41, '/api/notice/notice_id', 'PUT', 204, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

(42, '/api/mypage/*', 'GET', 205, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(43, '/api/mypage/*', 'PUT', 205, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(44, '/api/mypage/list', 'GET', 205, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(45, '/api/files/upload', 'POST', 206, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(9, 1, '207', 3, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(17, 2, '207', 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(26, 3, '207', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
